...
const hikeSchema = z.object({
  name: z.string().min(3).max(120), slug: z.string().regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/), description: z.string().min(20), storyTitle: z.string().min(5).max(240), startsAt: z.string().datetime({ offset: true }),
